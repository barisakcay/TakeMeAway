...
public let cities = [
    ...
    "Iğdır","Isparta","İstanbul Anadolu","İstanbulAvrupa","İzmir","Kahramanmaraş","Karabük","Karaman","Kars",
    "Kastamonu","Kayseri","Kilis","Kırıkkale","Kırklareli","Kırşehir","Kocaeli","Konya","Kütahya","Malatya",
